...
- **Definición**: Disciplina técnica que produce informes acerca del patrimonio de una entidad, su situación financiera y los resultados de sus operaciones, con el fin de facilitar la toma de decisiones económicas, tanto internas como externas.

- **Objetivos de la contabilidad**: Brindar información...
...
- **Terminología relacionada**:
	- **Vida útil técnica vs. vida útil contable**: la técnica se refiere al tiempo que un activo puede ser utilizado físicamente, mientras que la contable se refiere al plazo que la entidad espera que el activo contribuya a la generación de ingresos.
	- **Valor contable vs. valor fiscal vs. valor real**: el valor contable es el valor registrado en los libros (costo histórico menos la depreciación), el valor fiscal es el valor utilizado para fines tributarios, y el valor real es el valor de mercado o de reemplazo.
	- **Deuda vs. provisión vs. previsión**: la deuda es una obligación presente (sé cuánto y cuándo debo pagar), la provisión es un pasivo estimado para obligaciones futuras (sé cuándo pero no cuánto) y la previsión es un gasto anticipado para cubrir posibles pérdidas (no sé ni cuándo ni cuánto).

### Estados Contables

- **Balance**: Estado contable que presenta el estado patrimonial de una entidad en un momento específico, mostrando sus activos, pasivos y patrimonio neto.
	...
	- **Clasificación del pasivo**:
		- **Pasivo corriente**: Obligaciones que se espera liquidar en el mismo año (deudas bancarias/comerciales/fiscales, provisiones, previsiones).
		- **Pasivo no corriente**: Obligaciones que se espera liquidar en más de un año (deudas/provisiones/previsiones no corrientes).
...
- **Cuadro de resultados**: Estado contable que presenta la rentabilidad de una entidad durante un período específico, mostrando sus ingresos, costos y gastos. El resultado es la cuenta "utilidades".
...
| **➡ Utilidad Bruta** | Ganancia inicial antes de gastos operativos. | Ventas – Costo de ventas. |
| **Gastos de administración y ventas** | Gastos para operar el negocio. | Sueldos, cargas sociales, alquiler, publicidad, servicios. |
| **➡ Utilidad de Explotación** | Resultado después de restar gastos operativos. | Utilidad bruta – gastos de administración y ventas. |
| **Ingresos y gastos secundarios** | Resultados no principales (no operativos). | Intereses, comisiones, otros ingresos o gastos. |
| **➡ Utilidad Operativa** | Resultado de la actividad total del negocio. | Utilidad de explotación ± ingresos/gastos secundarios. |
| **Intereses ganados / pagados** | Resultados financieros. | Intereses por inversiones o deudas. |
| **➡ Utilidad Neta Operativa** | Resultado después de efectos financieros. | Utilidad operativa + intereses ganados – intereses pagados. |
| **Utilidad por venta de bien de uso** | Resultado extraordinario. | Ganancia por venta de activos fijos. |
| **➡ Utilidad Neta del Ejercicio** | Resultado antes de ajustes o impuestos. | Utilidad neta operativa +/– otros resultados. |
...
| **➡ Utilidad antes de impuesto a las ganancias (I.G.)** | Resultado final antes de impuestos. | Igual a la utilidad neta del ejercicio (si no hay ajustes). |
| **Impuesto a las ganancias (35%)** | Carga impositiva del periodo. | 35% de la utilidad antes de impuestos. |
| **➡ Utilidad Neta** | Ganancia final de la empresa. | Utilidad antes de impuestos – impuesto a las ganancias. |

- **Aspectos Económicos y Financieros**:
	- **Aspecto económico**: Se ve reflejado en el cuadro de resultados y en la cuenta de utilidades, mostrando la rentabilidad de la entidad.
	- **Aspecto financiero**: Se refleja en la cuenta disponibilidades (caja y bancos) del activo corriente del balance, mostrando la liquidez de la entidad. Tiene que ser lo suficiente para solventarse en caso de emergencias.

### Cuentas Contables

- **Cuentas Patrimoniales**: Reflejan los elementos del patrimonio (activo, pasivo, patrimonio neto).
	- **Activo**: Bienes y derechos de la entidad, ordenadas de mayor a menor liquidez.
...
- **Cuentas Transitorias**: Reflejan resultados del ejercicio (ingresos, costos, gastos), y de producción.
...
- **Definición**: Sistema contable que establece que cada transacción afecta al menos dos cuentas (una de inversión y otra de financiamiento), manteniendo el equilibrio de la ecuación contable (Activo = Pasivo + Patrimonio Neto).
...
- **Principios**:
	...
	- **Debe y Haber**: El debe registra los aumentos en cuentas de activo y gastos, mientras que el haber registra los aumentos en cuentas de pasivo, patrimonio neto e ingresos.
	...
	- **Devengamiento vs. cobro/pago**: El devengamiento reconoce ingresos y gastos cuando se generan, independientemente de cuándo se cobran o pagan.

### Plan de Cuentas, Libro Diario y Libro Mayor

- **Plan de Cuentas**: Estructura organizada y sistemática de todas las cuentas contables utilizadas por una entidad, clasificadas según su naturaleza y función.
	- **Objetivo**: Facilitar el registro, clasificación y análisis de las transacciones contables.
...
- **Libro Mayor**: Estado contable que registra los movimientos de cada una de las cuentas contables de una entidad.
	...
	- Permite conocer el saldo de cada cuenta en un momento determinado, ayudando a identificar errores y analizar la situación financiera.
...
- **Definición**: Impuesto indirecto que grava el consumo de bienes y servicios, aplicado en cada etapa del proceso productivo y comercial.
